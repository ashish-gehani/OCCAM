...
static llvm::cl::opt<std::string> FunctionName(
    "Padd-verifier-call-in-function",
    llvm::cl::desc(
        "Function where __VERIFIER_error() is inserted at its entry block"),
...
public:
  ...
  AddVerifierCalls() : ModulePass(ID), m_errorFn(nullptr), m_cg(nullptr) {}
  ...
  virtual bool runOnModule(Module &M) {
    ...
    m_errorFn =
        cast<Constant>(M.getOrInsertFunction("__VERIFIER_error",
...
public:
  ...
  RemoveVerifierCalls() : ModulePass(ID), m_errorFn(nullptr), m_cg(nullptr) {}
...
public:
  ...
  ReplaceVerifierCallWithUnreachableInst()
      : ModulePass(ID), m_errorFn(nullptr), m_cg(nullptr) {}
...
static RegisterPass<previrt::transforms::AddVerifierCalls>
    X("Padd-verifier-calls", "Add calls to __VERIFIER_error");

static RegisterPass<previrt::transforms::RemoveVerifierCalls>
    Y("Premove-verifier-calls", "Remove calls to __VERIFIER_error");
