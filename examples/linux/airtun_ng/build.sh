...
declare -a bitcode=(
    "airtun_ng-airtun-ng.o.bc"
    "libaclib_la-crypto.o.bc"
    "libaircrack_util_la-common.o.bc"
    "libaircrack_osdep_la-osdep.o.bc"
    "libaircrack_osdep_la-network.o.bc"
    "libaircrack_osdep_la-file.o.bc"
    "libaircrack_osdep_la-linux.o.bc"
    "libaircrack_osdep_la-linux_tap.o.bc"
    "libaircrack_osdep_la-common.o.bc"
    "radiotap.o.bc"
)
...
function dynamic_link() {
    ...
    cp ./slash_specialized/knockd_slashed .
}
