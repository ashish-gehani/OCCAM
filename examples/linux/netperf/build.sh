...
function usage() {
    echo "Usage: $0 [--disable-inlining] [--ipdse] [--use-crabopt] [--inter-spec VAL] [--intra-spec VAL] [--link dynamic|static] [--help]"
...
declare -a bitcode=("netperf.o.bc" "netlib.o.bc" "netsh.o.bc" "nettest_bsd.o.bc" "nettest_dlpi.o.bc" "nettest_unix.o.bc" "nettest_xti.o.bc" "nettest_sctp.o.bc" "nettest_sdp.o.bc" "nettest_omni.o.bc" "net_uuid.o.bc" "dscp.o.bc" "netcpu_procstat.o.bc")
...
function dynamic_link() {
    ...
    cp ./slash_specialized/netperf_slashed .
}
