...
slash --no-strip --devirt=sea_dsa --force-inline-spec --inter-spec-policy=nonrec-aggressive --intra-spec-policy=nonrec-aggressive --work-dir=slash multiple.manifest 
